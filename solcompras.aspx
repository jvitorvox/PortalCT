...
<%--                    <asp:Button ID="btnGestao" runat="server" class="btn btn-info" Text="Lotes" />
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <asp:TextBox ID="txtdt1" runat="server" class="form-control-pc" placeholder="Data Inicial" Width="10%" Style="margin-left: 1%" MaxLength="10" ToolTip="Data no formato  dd/mm/aaaa" TextMode="Time"></asp:TextBox>
