<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="copa.aspx.vb" Inherits="PortalCT.copa" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Informações Copa 2022</title>
    ...
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div style="margin-top: 8%; margin-left: 4%; text-align: center">
                <h2 class="page-header text-info">Copa do Mundo do Qatar 2022!</h2>
            </div>
        </div>
        <div class="row" style="margin-top: 1%">
            <div class="col-md-12">
                <img src="arquivos/JOGOS%20DO%20BRASIL.png" style="width: 50%; height: 50%" />
                <h5 class="page-header text-info">Horário de Brasilia GMT-3</h5>
            </div>
        </div>
        <div class="row" style="margin-top: 2%">
            <div class="col-md-12">
                <img src="arquivos/tabela%20Qatar%202022.png" style="width: 90%; height: 70%" />
                </div>
        </div>
                <div class="row" style="margin-top: 2%">
            <div class="col-md-12">
