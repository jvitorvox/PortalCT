<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="livros.aspx.vb" Inherits="PortalCT.livros" %>
    ...
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div style="margin-top: 8%; margin-left: 4%; text-align: center">
                <h2 class="page-header text-info">Bem vindos, escolha um livro, clique e boa leitura!</h2>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="row" style="margin-top: 2%">
                        <div class="form-group col-md-10" style="padding-left: 15%; padding-right: 1%">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    <tr>
                                        <td class="auto-style1" style="background-color: #3366FF; color: #FFFFFF">Livro</td>
                                        <td style="background-color: #3366FF; color: #FFFFFF">Autor</td>
                                    </tr>
                                    ...
                                    <asp:Repeater ID="Repeater1" runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                <td style="width: 50%">
                                                    <asp:LinkButton ID="lnkDownload" CommandArgument='<%# Eval("NomeArquivo") %>' runat="server" OnClick="DownloadFile" Text=' <%# Eval("NomeArquivo") %>'>                                                    
                                                    </asp:LinkButton></td>

                                                <td><%# Eval("Autor").ToString().Replace(".pdf","").Replace("-","") %></td>
