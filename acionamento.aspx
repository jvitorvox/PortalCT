<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="acionamento.aspx.vb" Inherits="PortalCT.acionamento" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Regras para Acionamento</title>
    ...
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div style="margin-top: 8%; margin-left: 4%; text-align: center">
                <h2 class="page-header text-info">Regras de Acionamento</h2>
            </div>
        </div>
        <div class="row" style="margin-top: 1%">
            <div class="col-md-12" style="margin-left: auto;margin-right: auto; text-align:center ">
                 <iframe src="arquivos/regras%20de%20acionamento.pdf" width="880" height="900" style="border: none; "></iframe>
            </div>
        </div>
